...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aK, request.a_, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {X: fragment, _: host, ac: path, ae: port_, ah: protocol, ai: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ax: false, az: r.az, aE: r.aE, Y: r.Y, aK: r.aK, aY: r.aY, ar: r.ar, a_: r.a_}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{az: $elm$http$Http$emptyBody, aE: r.aE, Y: _List_Nil, aK: 'GET', aY: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, a_: r.a_});
};
var $author$project$Main$fetchContent = function (slug) {
	return $elm$http$Http$get(
		{
			aE: $elm$http$Http$expectString(
				$author$project$Main$GotContent(slug)),
			a_: '/posts/' + (slug + '.md')
		});
};
...
var $author$project$Main$PostDetail = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$PostDetail,
			A2(
	...
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			...
			function () {
				if (route.$ === 1) {
					var slug = route.a;
					return $author$project$Main$fetchContent(slug);
				} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'margin', '4px 0 12px 0')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewHome = A2(
	...
	_List_fromArray(
		[
			...
			$elm$html$Html$div,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Main$viewPostTeaser, $author$project$Main$postsMetadata))
		]));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('dankey@blog')
							]))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background', 'rgba(30, 30, 38, 0.88)'),
						A2($elm$html$Html$Attributes$style, 'border-radius', '18px'),
						A2($elm$html$Html$Attributes$style, 'box-shadow', '0 25px 50px rgba(0, 0, 0, 0.35)'),
						A2($elm$html$Html$Attributes$style, 'color', '#f0f0f0')
					]),
				_List_fromArray(
					[
						...
						switch (_v0.$) {
							...
							case 1:
								var slug = _v0.a;
								return A2($author$project$Main$viewPost, model, slug);
							default:
								return $author$project$Main$viewNotFound;
						}
					}()
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		aM: $author$project$Main$UrlChanged,
		aN: $author$project$Main$LinkClicked,
